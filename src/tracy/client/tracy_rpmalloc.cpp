...
#else
	int defer_val = ((span->heap->owner_thread != get_thread_id()) && !span->heap->finalize);
#endif
	if (!defer_val)
...
#if RPMALLOC_FIRST_CLASS_HEAPS
	int defer_val = (span->heap->owner_thread && (span->heap->owner_thread != get_thread_id()) && !span->heap->finalize);
#else
	int defer_val = ((span->heap->owner_thread != get_thread_id()) && !span->heap->finalize);
#endif
	if (defer_val) {
