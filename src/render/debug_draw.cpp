...
void init_debug_geometry_draw_queue() {
    ...
    debug_draw_queue.vertex_data = push_array(pers, MAX_DEBUG_DRAW_QUEUE_BUFFER_SIZE, f32);
    
    Vertex_Attrib_Type attribs[] = { VERTEX_ATTRIB_F32_V3, VERTEX_ATTRIB_F32_V3 };
    debug_geometry_vbi = create_vertex_buffer(attribs, c_array_count(attribs), null, MAX_DEBUG_DRAW_QUEUE_VERTEX_COUNT, BUFFER_USAGE_STREAM);
