...
inline constexpr u32 UNIFORM_BLOCK_BINDING_CAMERA        = 0;
inline constexpr u32 UNIFORM_BLOCK_BINDING_VIEWPORT      = 1;
inline constexpr u32 UNIFORM_BLOCK_BINDING_DIRECT_LIGHTS = 2;
inline constexpr u32 UNIFORM_BLOCK_BINDING_POINT_LIGHTS  = 3;

inline constexpr u32 UNIFORM_BLOCK_BINDINGS[] = {
...
inline constexpr String UNIFORM_BLOCK_NAME_CAMERA        = S("Camera");
inline constexpr String UNIFORM_BLOCK_NAME_VIEWPORT      = S("Viewport");
inline constexpr String UNIFORM_BLOCK_NAME_DIRECT_LIGHTS = S("Direct_Lights");
inline constexpr String UNIFORM_BLOCK_NAME_POINT_LIGHTS  = S("Point_Lights");

inline constexpr String UNIFORM_BLOCK_NAMES[] = {
