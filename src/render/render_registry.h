...
inline constexpr s32 MAX_VERTEX_ARRAYS   = 64;
...
inline constexpr s32 MAX_UNIFORM_BUFFERS = 8;
inline constexpr s32 MAX_UNIFORM_BLOCKS  = 64;

struct Render_Registry {
    Sparse_Array<Frame_Buffer>   frame_buffers;
    Sparse_Array<Vertex_Buffer>  vertex_buffers;
    Sparse_Array<Vertex_Array>   vertex_arrays;
    ...
    Sparse_Array<Uniform_Buffer> uniform_buffers;
    Sparse_Array<Uniform_Block>  uniform_blocks;
