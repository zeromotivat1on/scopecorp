...
static void log_output_va(Log_Level log_level, const char *format, va_list args) {
	...
	u64 count = stbsp_vsnprintf(buffer, sizeof(buffer), format, args);
...
s8  str_to_s8 (String s) { return (s8 )str_to_s64(s); }
s16 str_to_s16(String s) { return (s16)str_to_s64(s); }
s32 str_to_s32(String s) { return (s32)str_to_s64(s); }
...
u8  str_to_u8 (String s) { return (u8 )str_to_u64(s); }
u16 str_to_u16(String s) { return (u16)str_to_u64(s); }
u32 str_to_u32(String s) { return (u32)str_to_u64(s); }
